...
ML_master is a copy of the central_uart program in nrf. The goal of this program is to make a state machine that can control a another nrf53_52 flashed with the nrf53_52_woodpecker_detector program. The rest of the README is copyed from the central uart example:
