...
1. |connect_kit|
#. Connect to the kit with using J-LINK RTT viewer. Note: the Thingy:52 does not have a debugger, so you will need an external debugger (for example the nRF5340 development kit) and a `10-pin cable <https://www.adafruit.com/product/1675>`_.
#. Reset the Thingy:52.
